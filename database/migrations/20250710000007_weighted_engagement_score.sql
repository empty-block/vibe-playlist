-- Update analytics functions to use weighted engagement scores
-- Weighting: Sharers (x10), Recastsers (x5), Likers (x3), Repliers (x2)
...
-- Create get_top_artists_by_time_range function with weighted engagement
...
-- Create get_top_songs_by_time_range function with weighted engagement
...
-- Create get_top_genres_by_time_range function with weighted engagement
